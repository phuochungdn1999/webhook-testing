    ...
    const navs = [
        {
            ...
            redirect: "https://www.wonderemkart.com/communication-preferences/push",
        },
        {
            title: "Sell on WonderEmkart",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.wonderemkart.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.wonderemkart.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.wonderemkart.com/mobile-apps",
        },
    ]
